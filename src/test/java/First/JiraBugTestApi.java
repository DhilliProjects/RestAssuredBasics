...
public class JiraBugTestApi {
	...
	public static void main(String[] args) {
		...
		//Note: Replace with your domain and Jira-API-Token before executing
		RestAssured.baseURI = "https://yourdomain.atlassian.net"; //Use your domain from your Jira account
		...
		//Add the token and username(your Jira login mail) in Authorization tab in Postman as like you this in manual testig in Postman
		...
		String createIssueResponse = given().header("Content-Type", "application/json")
				...
				.body("{\r\n"
						...
						+ "          \"key\": \"SCRUM\"\r\n"
						+ "       },\r\n"
						+ "       \"summary\": \"Buttons are not woring properly\",\r\n"
						+ "       \"issuetype\": {\r\n"
						+ "          \"name\": \"Bug\"\r\n"
						+ "       }\r\n"
						+ "   }\r\n"
		...
		.multiPart("file", new File("C:\\Users\\kdhil\\OneDrive\\Documents\\attach.jpg")) //Paste your file location here. Instead of body, we use multiPart() method in RestAssured and add the location of File using File object. In manual Postman API testing, we use 'file' as Key and select File option and uplaod the image in Value.
		.log().all()
		...
		.then().log().all().assertThat().statusCode(200); //for upload image in Issue in Jira, status code is 200
